...
- **agent `al-planning-subagent`**: "Found: Table 18 Customer has 3 extensions, 2 event subscribers on OnValidate. Return to conductor."

### Recommended Workflow

```
1. agent `al-architect` (DESIGN)
...
4. agent `al-developer` (ADJUST, optional)
...
**agent `al-conductor` reads this file**:
...
**agent `al-developer` reads this file**:
