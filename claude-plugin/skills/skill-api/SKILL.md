...
Document in `app/requirements/in-progress/{req_name}/{req_name}.architecture.md` or a dedicated API design section.
...
6. Build: `Bash: al compile` (`al workspace compile` for a multi-project workspace)
